	<div class="form-container" id="frmdash_acc">
		<div class="roller" id="master">
			...
			<div class="grid_3"> 
				<a href="<?php echo site_url('apotek/view_coa');?>">
					<img src= "resources/images/write.png" alt="COA">
				</a>
			</div>
			<div class="grid_3"> 
				<a href="<?php echo site_url('apotek/view_ledger');?>">
					 <img src= "resources/images/number.png" alt="Ledger">
				</a>
			</div>			
			<div class="grid_3" >
				<a href="<?php echo site_url('apotek/view_balance');?>">
		...
		<div class="roller" id="generate">
			<div class="grid_3"> &nbsp; </div>
			<div class="grid_3"> 
				<a href="<?php echo site_url('apotek/gen_pl');?>">
					<img src= "resources/images/board.png" alt="Profit/Loss">
				</a>
			</div>
			<div class="grid_3"> 
				<a href="<?php echo site_url('apotek/gen_post');?>">
					<img src= "resources/images/spread.png" alt="Posting">
				</a>
			</div>
			<div class="grid_3"> 
				<a href="<?php echo site_url('apotek/gen_closed');?>">
