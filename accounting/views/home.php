<div class="inner">
	...
	<div class="form-container" id="frmdash_acc">
		<div class="roller" id="master">
			...
			<div class="grid_3"> 
				<a href="<?php echo site_url('accounting/view_coa');?>">
		...
		<div class="roller" id="generate">
			<div class="grid_3"> &nbsp; </div>
			<div class="grid_3"> 
				<a href="<?php echo site_url('accounting/gen_pl');?>">
					<img src= "resources/images/board.png" alt="Profit/Loss">
				</a>
			</div>
			<div class="grid_3"> 
				<a href="<?php echo site_url('accounting/gen_post');?>">
					<img src= "resources/images/spread.png" alt="Posting">
				</a>
			</div>
			<div class="grid_3"> 
				<a href="<?php echo site_url('accounting/gen_closed');?>">
